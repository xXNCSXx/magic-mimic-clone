  ...
  return (
    <section id="habilidades" className="py-20 px-6 min-h-screen">
      <div className="container mx-auto relative">
        <MaskContainer
          ...
          revealText={
            <div className="w-full">
              <h2 className="text-4xl md:text-6xl font-black text-highlight text-center w-full mb-16">
                Habilidades
              </h2>
        ...
        >
          <div className="w-full">
            <h2 className="text-4xl md:text-6xl font-black text-accent text-center w-full mb-16">
              Habilidades
            </h2>
            <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              {skillCategories.map((category, categoryIndex) => (
